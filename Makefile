...
ifdef ARCH_WIN
	...
	cd dep/projectm/build && cmake -G "Ninja" -DBUILD_SHARED_LIBS="OFF" -DCMAKE_LIBRARY_PATH=dep/lib -DCMAKE_CXX_STANDARD_LIBRARIES=-lpsapi -DENABLE_SHARED_LIB="OFF" -DENABLE_OPENMP="OFF" -DCMAKE_BUILD_TYPE=Release -DENABLE_THREADING="OFF" -DENABLE_SDL="OFF" -DENABLE_PLAYLIST="OFF" -DCMAKE_INSTALL_PREFIX=../../../src/ ..
...
#	sed -i 's/CMAKE_CXX_STANDARD_LIBRARIES:STRING=/CMAKE_CXX_STANDARD_LIBRARIES:STRING= ..\/..\/..\/dep\/libRack.dll.a -lpsapi /g' dep/projectm/build/CMakeCache.txt; 
	...
	cd dep/projectm/build && cmake -DBUILD_SHARED_LIBS="OFF" -DCMAKE_LIBRARY_PATH=dep/lib -DENABLE_OPENMP="OFF" -DCMAKE_BUILD_TYPE=Release -DENABLE_THREADING="OFF" -DENABLE_SDL="OFF" -DENABLE_PLAYLIST="OFF" -DCMAKE_INSTALL_PREFIX=../../../src/ ..
endif
