...
public:
  ...
  void init(GLFWwindow*,mySettings const& s,int*,int*,int*,int*,bool,bool);
...
private:
  ...
  int renderHeight{ 0 };
  int windowHeight{ 0 };
  virtual GLFWwindow* createWindow(GLFWwindow*,int*,int*,int*,int*,bool) = 0;
};
...
private:
  ...
  GLFWwindow* createWindow(GLFWwindow*,int*,int*,int*,int*,bool) override;
